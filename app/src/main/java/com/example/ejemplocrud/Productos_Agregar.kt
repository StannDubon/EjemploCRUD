...
private lateinit var btnCanelar:Button

private lateinit var spinner:Spinner

class Productos_Agregar : AppCompatActivity() {
    @SuppressLint("MissingInflatedId", "ResourceType")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_productos_agregar)

        //Empezamos con mandar a llamar la conexion
        val conn = conexionSQL().dbConn()
        ...
        btnCanelar=findViewById(R.id.AgregarProducto_cancelar)
